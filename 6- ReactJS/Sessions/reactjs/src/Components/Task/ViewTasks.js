...
import { deleteTask } from '../../Reducers/action';
                        ...
                        tasks.map((task, index) => {
                            return (
                                <tr key={index}>
                                    ...
                                    <th>
                                        <span style={{ textDecoration: 'none', backgroundColor: 'red', color: 'white', padding: '5px', borderRadius: '5px', cursor: 'pointer' }} onClick={() => deleteTaskFunc(index)}> delete </span>
                                    </th>
                                </tr>
                            )
                        })
