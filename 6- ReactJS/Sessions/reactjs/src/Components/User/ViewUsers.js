                        ...
                        users.map((user, index) => {
                            return (
                                <tr key={index}>
                                    ...
                                    <th>
                                        <span style={{ textDecoration: 'none', backgroundColor: 'red', color: 'white', padding: '5px', borderRadius: '5px', cursor: 'pointer' }} onClick={() => deleteUserFunc(index)}> delete </span>
                                    </th>
                                </tr>
                            )
                        })
